...
namespace JBL{
    ...
    namespace MEMORY{
        ...
        template<typename OBJ> extern inline OBJ* __ALLOC(const _SIZE_T size){
        ...
        template<typename OBJ, typename... T> extern inline OBJ* __NEW(T&&... argv){
            OBJ* _new = nullptr;
        ...
        /// @param argv 생성자에 따른 인자
        /// @return 해당 자료형에 따른 객체. 실패시 nullptr를 반환합니다.
        template<typename OBJ, typename... T> extern inline OBJ* __NEW_ALIGNED_CUSTOM(const _SIZE_T aliSz, T&&... argv){
        ...
        /// @param argv 생성자에 따른 인자
        /// @return 해당 자료형에 따른 객체. 실패시 nullptr를 반환합니다.
        template<typename OBJ, typename... T> extern inline OBJ* __NEW_ALIGNED16(T&&... argv){
        ...
        template<typename OBJ, typename... T> extern inline void __DELETE_ALIGNED(OBJ* tar, T&&... argv){
